...
export default function SignUpPage() {
  ...
  return (
    <main className="flex-1 flex items-center justify-center px-4 py-12 bg-gradient-to-b from-blue-50/80 to-white">
      <Card className="w-full max-w-md shadow-xl shadow-primary/5 border-border/50">
        <CardHeader className="text-center pb-2">
          <Link href="/" className="inline-flex items-center justify-center gap-2 mb-6">
            ...
            <span className="font-semibold text-xl">VoteTrack</span>
          </Link>
          <CardTitle className="text-2xl">Create an account</CardTitle>
          <CardDescription>
            Enter your email to get started with VoteTrack
          </CardDescription>
        </CardHeader>
